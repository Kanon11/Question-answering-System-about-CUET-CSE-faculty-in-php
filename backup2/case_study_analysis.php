 	...
 	<div class="grid-system">
 		...
 		<p class=""> Feel Free to ask any query !</p>
			...
			<h4>Feedback Information</h4>
							...
							<thead> <tr>  
							<th>ID  </th>  <th>User ID </th> <th> Case Study </th> <th>Analysis</th> </tr> 
							</thead> 
...
$user_id=$_SESSION['user_id'];
  		$sql="SELECT * FROM case_study  WHERE user_id='$user_id'";
...
while($row= mysql_fetch_array($result))
  ...
  echo "<tr>";
   ...
   $v_type=$row['user_id'];
   $v_name=$row['case_study'];
  
echo"<td> $idr</td>";
echo"<td> $v_type</td>";
echo"<td> $v_name</td>";
echo"<td> <a href='case_study_analysis2.php?id=$idr'> Analysis</a></td>";
