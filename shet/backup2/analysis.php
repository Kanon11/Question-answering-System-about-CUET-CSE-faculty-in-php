...
<div id="wrapper">
 	...
 	<div class="grid-system">
 		...
 		<p class=""> Feel Free to ask any query !</p>
			...
			<h4>Analysis Permormance </h4>
			
							<table class="table table-bordered"> 
							<thead> <tr>  
							<th>ID  </th> <th>Query ID </th>  <th> Feedback ( F1 ) </th> <th>Feedback ( F2 )</th> <th>Feedback ( F3 ) </th> <th>Feedback ( F4 ) </th> <th>Graph</th></tr> 
							</thead> 
...
$user_id=$_SESSION['user_id'];
  		$sql="SELECT id,kb_id as kkb_id,SUM(f1) as ff1,SUM(f2) as ff2,SUM(f3) as ff3,SUM(f4) as ff4,(SUM(f1)+SUM(f2)+SUM(f3)+SUM(f4)) as total_sum FROM `feedback` GROUP BY kb_id";
...
echo"<td> $factor</td>";
echo"<td> $ff</td>";
echo"<td> <a href='analysis2.php?f1=$ff&f2=$factor&f3=$status&f4=$v_name'> Graph Analysis</a></td>";
 echo "</tr>";
}
